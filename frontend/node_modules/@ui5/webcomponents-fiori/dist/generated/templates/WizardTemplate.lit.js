...
function block0(context, tags, suffix) { return html `<div class="${classMap(this.classes.root)}" aria-label="${ifDefined(this.ariaLabelText)}" role="region"><nav class="ui5-wiz-nav" part="navigator" aria-label="${ifDefined(this.navAriaLabelText)}" tabindex="-1"><div class="ui5-wiz-nav-list" role="list" aria-label="${ifDefined(this.listAriaLabelText)}" aria-describedby="wiz-nav-descr" aria-controls="${ifDefined(this._id)}-wiz-content">${repeat(this._stepsInHeader, (item, index) => item._id || index, (item, index) => block1.call(this, context, tags, suffix, item, index))}</div></nav><span id="wiz-nav-descr" class="ui5-hidden-text">${ifDefined(this.navAriaDescribedbyText)}</span><div id="${ifDefined(this._id)}-wiz-content" class="ui5-wiz-content" @scroll="${this.onScroll}">${repeat(this._steps, (item, index) => item._id || index, (item, index) => block2.call(this, context, tags, suffix, item, index))}</div></div>`; }
