...
declare class Menu extends UI5Element {
    ...
    _getSubmenuReference(item: MenuItem): Menu | undefined;
    _clonedItemsFragment(item: MenuItem): DocumentFragment;
    _openItemSubMenu(item: MenuItem, opener: HTMLElement): Promise<void>;
    ...
    _prepareSubMenu(item: MenuItem, opener: HTMLElement): Promise<void>;
    _onfocusin(e: FocusEvent): void;
    _startOpenTimeout(item: MenuItem, opener: HTMLElement): void;
    ...
    _getParentMenuItem(element: MenuItem | Menu): MenuItem | undefined;
